const connections = [
    { source: "item1", target: ["item3", "item5"] },
    { source: "item2", target: ["item1", "item5"] },
    { source: "item3", target: ["item4", "item5"] },
    { source: "item4", target: ["item2", "item3"] },
    { source: "item5", target: ["item1", "item3"] },
  ];
...
//           .attr("x1", source.offsetLeft + source.clientWidth / 2)
//           .attr("y1", source.offsetTop + source.clientHeight / 2)
//           .attr("x2", target.offsetLeft + target.clientWidth / 2)
//           .attr("y2", target.offsetTop + target.clientHeight / 2)
//           .attr("stroke", "#FF0000")
//           .attr("stroke-width", 2)
//           .attr("class", "line");
//       });
...
//             .selectAll(".line") // Select all lines within the connected item
//             .attr("stroke", "#e74c3c"); // Update stroke color for selected items
//             d3.selectAll(".line").filter(`:has(#${target})`).attr("stroke", "#FF0000");
//         });
//       }
//     });
//   }
